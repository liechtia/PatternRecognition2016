...
public class MainKeywordSpottingOld {
    ...
    public static void main(String[] args) {
        ...
        HashMap<String, ArrayList<KeywordImage>> trainingImages =  new HashMap<String, ArrayList<KeywordImage>>();
        HashMap<String, ArrayList<KeywordImage>> validImages =  new HashMap<String, ArrayList<KeywordImage>>();
