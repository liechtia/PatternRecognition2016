 ...
 */
public class MultilayerPerceptronCustom 
  extends Classifier 
  ...
  public static void main(String [] argv) {
    runClassifier(new MultilayerPerceptronCustom(), argv);
  }
   ...
   * The constructor.
   */
  public MultilayerPerceptronCustom() {	  
    m_instances = null;
  ...
  public void buildClassifier(Instances i) throws Exception {
	...
	return;
      	...
      	ObjectOutputStream oos = new ObjectOutputStream(
      			new FileOutputStream("mlp/temp/" + noa + ".model"));
