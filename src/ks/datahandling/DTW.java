...
public class DTW {
	 ...
	 */
	public double computeDTW(Image trainImage, Image testImage,
							 int band) {
		List<FeatureVector> train = trainImage.getFeatures();
		List<FeatureVector> test = testImage.getFeatures();
	 ...
	 */
 	public double calcDistance(FeatureVector vector1, FeatureVector vector2) {
